...
data_matrix = pd.read_csv('MLAI_Career_Path\\Unsupervised Learning Algorithms I\\PCA\\data_matrix.csv', index_col=0)
classes = pd.read_csv('MLAI_Career_Path\\Unsupervised Learning Algorithms I\\PCA\\classes.csv', index_col=0)['class']
